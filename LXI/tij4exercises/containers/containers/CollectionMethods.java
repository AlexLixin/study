...
public class CollectionMethods {
    public static void main(String[] args) {
        ...
        print("Collections.max(c) = " + Collections.max(c)); //$NON-NLS-1$
        print("Collections.min(c) = " + Collections.min(c)); //$NON-NLS-1$
        ...
        print("c.contains(" + val + ") = " + c.contains(val)); //$NON-NLS-1$ //$NON-NLS-2$
        //Is a Collection in this Collection?
        print("c.containsAll(c2) = " + c.containsAll(c2)); //$NON-NLS-1$
        ...
        c2.removeAll(c3);
        print("c2.isEmpty() = " + c2.isEmpty()); //$NON-NLS-1$
        c = new ArrayList<String>();
        c.addAll(Countries.names(6));
        print(c);
        c.clear(); // Remove all elements
        print("after c.clear():" + c); //$NON-NLS-1$
    }
} /* Output:
