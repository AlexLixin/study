...
public class CallableDemo {
	public static void main(String[] args) {
		 ...
		 * (Future<String> fs : results) try { // get() blocks until completion:
		 * System.out.println(fs.get()); } catch (InterruptedException e) {
		 * System.out.println(e); return; } catch (ExecutionException e) {
		 * System.out.println(e); } finally { exec.shutdown(); }
		 */
	}
}
/*
